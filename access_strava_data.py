...
for column in activities.columns:
    if str(activities[column].dtype) == 'object':
        activities[column] = activities[column].astype('str')

#Create database
database_path = r'/Users/natekistler/Documents/Projects/strava-raw-data/strava_data.db'

con = sqlite3.connect(database_path)

activities.to_sql('NateStravaData_All', con, if_exists='replace')
